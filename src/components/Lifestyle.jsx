...
function Chores(){
  ...
  const [state, setState] = React.useState({
    Filters:[{
      head: 'Lifestyle',
      mainQ: "Do you smoke or drink?",
      choicesQ: [{value: "Drink"},{value: "Smoke"},{value: "No"}]
    },{
      mainQ: "Do you have pets?",
      choicesQ: [{value: "Yes"},{value: "No"}]
    },{
      mainQ: "How often do your friends come over?",
      choicesQ: [{value: "Barely"},{value: "Very often"}]
    },{
      mainQ: "What conditions do you require to sleep?",
      choicesQ: [{value: "Lights off"}, {value: "No noise"}, {value: "No conditions"}, {value: "With Music"}]
    },{
      mainQ: "What time do you generally wake up and go to bed?",
      choicesQ: [{value: "9:00 - 10:00"}, {value: "Past Midnight"}, {value: "10:00-11:00"}]
    }
    ],
    selected: [
