...
function Chores(){
  ...
  const [state, setState] = React.useState({
    Filters:[{
      head: 'Schedule',
      mainQ: "What’s your typical schedule?",
      choicesQ: [{value: "Busy during the day"},{value: "Busy part of the day"},{value: "Busy during the night only"},{value: "Busy both day and night"}],
  ...
  const [roomie, setRoomie] = React.useState({
    Filters:[{
      ...
      mainQ: "How should your roommates schedule be?",
      choicesQ: [{value: "Their schedule should align with yours allowing the two of you to work together and hang out from time to time"},
            {value: "They should have a different schedule, allowing them some time to have the apartment to themselves?"},
          {value: "Am not sure"}],
    }
    ],
    selectedR: [
