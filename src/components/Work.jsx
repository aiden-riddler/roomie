...
function Chores(){
  ...
  const handleClick = (event,value) => {
    setChips((chips) => {
      const selectedProffessions = [...chips.selectedProffessions,value];
      return {
        selectedProffessions
      }
    });
    console.log(chips.selectedProffessions);

  }

  const handleDelete = (data) => {
    setChips((chips) => {
      const selectedProffessions = chips.selectedProffessions.filter((obj) => obj !== data);
      return {
        selectedProffessions
      }
    })
...
<Typography className={classes.title} color="textSecondary" gutterBottom>
  Which kind of professionals would you like to be matched with?
</Typography>
{chips.selectedProffessions.map((data) => {
    return (
      <li>
            <Chip
              label={data}
