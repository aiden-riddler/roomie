...
function Chores(){
  ...
  const [state, setState] = React.useState({
    Filters:[{
      head: "Temperaments",
      mainQ: "What's your idea of a good time?",
      choicesQ: [
        {value: "Parties and lots of socializing"},{value: "quiet night with a book"},{value: "Playing video games"},{value: "Watching a movie."}],
    },{
      mainQ: "Would you self-identify as introverted or extroverted?",
      choicesQ: [{value:"introverted"}, {value:"extroverted"}]
    }
    ],
    selected: [
  ...
  const [roomie, setRoomie] = React.useState({
    Filters:[{
      mainQ: "What's your idea of a good time?",
      choicesQ: [{value: "Parties and lots of socializing"},{value: "quiet night with a book"},{value: "Playing video games"},{value: "Watching a movie."}],
