  ...
  {state.Filters.map((ele) => {
    return (
      ...
      {ele.choicesQ.map((item) => {
        ...
        <FormControlLabel
         control={<GreenCheckbox checked={item.checked || false} onChange={() => handleChange(id,value,ele.mainQ)}/>}
         label={item.value}/>
        </FormGroup>)
      })}
      </React.Fragment>
...
{roomie.Filters.map((ele) => {
  return (
    ...
    {ele.choicesQ.map((item) => {
      return (<FormGroup row>
      <FormControlLabel
       control={<GreenCheckbox checked={item.checked || false} onChange={() => handleRoomieChange(item.value,ele.mainQ)}/>}
       label={item.value}/>
      </FormGroup>)
    })}
    </React.Fragment>
